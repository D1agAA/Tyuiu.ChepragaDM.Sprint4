...
using Tyuiu.ChepragaDM.Sprint4.Task1.V7.Lib;


namespace Tyuiu.ChepragaDM.Sprint4.Task1.V7
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* статическими значениями в диапазоне от 1 до 8 подсчитать сумму четных   *");
